...
import 'vipoffers_model.dart';
export 'vipoffers_model.dart';

class VipoffersWidget extends StatefulWidget {
  const VipoffersWidget({Key? key}) : super(key: key);

  @override
  _VipoffersWidgetState createState() => _VipoffersWidgetState();
}

class _VipoffersWidgetState extends State<VipoffersWidget> {
  late VipoffersModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => VipoffersModel());
