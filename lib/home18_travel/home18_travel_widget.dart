...
class Home18TravelWidget extends StatefulWidget {
  const Home18TravelWidget({Key? key}) : super(key: key);

  @override
  _Home18TravelWidgetState createState() => _Home18TravelWidgetState();
}

class _Home18TravelWidgetState extends State<Home18TravelWidget>
    with TickerProviderStateMixin {
  late Home18TravelModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Home18TravelModel());
                            ...
                            children: [
                              ...
                              Row(
                                ...
                                children: [
                                  Expanded(
                                    child: Text(
                                      'Beachside retreats: Where sandcastles become your architectural masterpiece and seashells are your treasures.',
                                      style: FlutterFlowTheme.of(context)
                                          .labelMedium
                                          .override(
                                            fontFamily: 'Plus Jakarta Sans',
                            ...
                            children: [
                              ...
                              Row(
                                ...
                                children: [
                                  Expanded(
                                    child: Text(
                                      'When you stay near resorts, you\'re not a tourist; you\'re a privileged guest of Mother Nature.',
                                      style: FlutterFlowTheme.of(context)
                                          .labelMedium
                                          .override(
                                            fontFamily: 'Plus Jakarta Sans',
