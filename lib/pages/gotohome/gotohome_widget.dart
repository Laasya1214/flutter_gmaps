...
import 'gotohome_model.dart';
export 'gotohome_model.dart';

class GotohomeWidget extends StatefulWidget {
  const GotohomeWidget({Key? key}) : super(key: key);

  @override
  _GotohomeWidgetState createState() => _GotohomeWidgetState();
}

class _GotohomeWidgetState extends State<GotohomeWidget>
    with TickerProviderStateMixin {
  late GotohomeModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => GotohomeModel());
                                        ...
                                        Padding(
                                          padding:
                                              EdgeInsetsDirectional.fromSTEB(
                                                  0.0, 16.0, 0.0, 0.0),
                                          child: Text(
                                            'I have some great travel options here!! Njoy!!',
                                            textAlign: TextAlign.center,
                                            style: FlutterFlowTheme.of(context)
                                                .labelLarge
                                                .override(
                                        ...
                                        Padding(
                                          padding:
                                              EdgeInsetsDirectional.fromSTEB(
                                                  0.0, 16.0, 0.0, 0.0),
                                          child: Text(
                                            'I have some great travel options here!!Have funn!!',
                                            textAlign: TextAlign.center,
                                            style: FlutterFlowTheme.of(context)
                                                .labelLarge
                                                .override(
